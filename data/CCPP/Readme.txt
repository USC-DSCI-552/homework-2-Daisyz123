...
For comparability with our baseline studies, and to allow 5x2 fold statistical tests be carried out, we provide the data shuffled five times. For each shuffling, a 2-fold CV is carried out, and the resulting 10 measurements are used for statistical testing.
